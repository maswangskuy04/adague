...
export default function AccountManagement() {
  return (
    <SettingSection delay={0.9}>
      <SettingCard icon={<ArrowLeftRight size={20} className='text-indigo-500' />} title='Data & Account Management'>
        <div className="flex flex-col space-y-2">
          <div className="flex items-center justify-between px-3 py-2">
            <span className="text-xs md:text-sm text-gray-600">Export data</span>
          ...
          <div className="flex items-center justify-between px-3 py-2">
            <span className="text-xs md:text-sm text-gray-600">Clear history / cache</span>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-2 justify-between px-3 py-2 rounded-lg border border-red-200 bg-red-50">
            <div className="flex flex-col">
              <span className="text-sm text-red-600 font-semibold">Danger zone</span>
              <span className="text-xs md:text-sm text-gray-600">Choose your action</span>
            </div>
